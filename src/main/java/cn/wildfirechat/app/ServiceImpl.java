...
public class ServiceImpl implements Service {
    ...
    public static org.apache.logging.log4j.Logger log = LogManager.getLogger(ServiceImpl.class);
    ...
    public RestResult login(String mobile, String code, String clientId) {
        ...
        /*try {
            ...
            //server服务器错误
                ...
                log.error("Get user failure {}", userResult.msg);
                return RestResult.error(RestResult.RestCode.ERROR_SERVER_ERROR);
            }
            InputOutputUserInfo user = userResult.getResult();
            ...
            if (tokenResult.getErrorCode() != ErrorCode.ERROR_CODE_SUCCESS) {
                log.error("Get userToken failure {}", tokenResult.code);
                return RestResult.error(RestResult.RestCode.ERROR_SERVER_ERROR);
            }
